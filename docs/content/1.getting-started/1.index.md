...
Docus is a theme is based on the [UI Pro documentation template](https://docs-template.nuxt.dev/). While the visual style comes ready out of the box, your focus should be on writing content using the MDC syntax provided by [Nuxt Content](https://content.nuxt.com).
