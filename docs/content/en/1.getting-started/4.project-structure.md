...
description: Learn about the project structure of Docus.
navigation:
...
::tip{to="/en/concepts/edition"}
You can separate your documentation files within a `docs/` subfolder to make them accessible at the `/docs` route. Additionally, you have the flexibility to override your landing page using custom Vue pages if desired.
::
