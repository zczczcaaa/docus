...
to: https://github.com/nuxtlabs/docus/blob/feat/docus-v2/app/components/app/AppHeaderLogo.vue
variant: link
---
...
::prose-note
---
to: https://github.com/nuxtlabs/docus/blob/feat/docus-v2/docs/components/AppHeaderCTA.vue
---
...
color: neutral
icon: i-lucide-code-xml
to: https://github.com/nuxtlabs/docus/blob/feat/docus-v2/app/components/app/AppHeaderCenter.vue
variant: link
---
Default component code
::
...
color: neutral
icon: i-lucide-code-xml
to: https://github.com/nuxtlabs/docus/blob/feat/docus-v2/app/components/app/AppHeaderBody.vue
variant: link
---
Default component code
::
...
color: neutral
icon: i-lucide-code-xml
to: https://github.com/nuxtlabs/docus/blob/feat/docus-v2/app/components/docs/DocsHeaderRight.vue
variant: link
---
Default component code
::
...
color: neutral
icon: i-lucide-code-xml
to: https://github.com/nuxtlabs/docus/blob/feat/docus-v2/app/components/docs/DocsAsideRightBottom.vue
variant: link
---
Default component code
::
...
To customize top part of the left aside of the documentation pages. You can create the`components/DocsAsideLeftBottom.vue` component.
