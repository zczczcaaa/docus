...
![Visualisation du logo d'en-tête](/documentation/app-header-logo.webp)
...
![Visualisation du CTA d'en-tête](/documentation/app-header-cta.webp)
...
![Visualisation du centre d'en-tête](/documentation/app-header-center.webp)
...
![Visualisation du menu mobile](/documentation/app-header-body.webp)
...
Lorsque [`navigation.sub`](/fr/concepts/configuration#sous-navigation) est défini sur `'header'`, Docus affiche une barre d'onglets secondaire sous l'en-tête. Pour ajouter du contenu personnalisé à droite de cette barre (ex. un toggle, un badge), créez un composant `components/AppHeaderBottomRight.vue`.
...
![Visualisation du footer gauche](/documentation/app-footer-left.webp)
...
![Visualisation du footer droit](/documentation/app-footer-right.webp)
...
![Docs aside droit bas](/documentation/docs-aside-right-bottom.webp)
