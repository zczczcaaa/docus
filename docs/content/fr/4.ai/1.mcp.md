...
Puisque Docus utilise le module [`@nuxtjs/mcp-toolkit`](https://mcp-toolkit.nuxt.dev/), vous pouvez étendre le serveur MCP avec des outils, ressources, prompts et handlers personnalisés.
