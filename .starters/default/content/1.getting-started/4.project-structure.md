...
This is where you [write pages](/concepts/edition) in Markdown. Docus automatically generates routes based on your file structure.
...
::prose-tip
More information about i18n is available in the [Internationalization](/concepts/internationalization) section.
::
...
This is where you can [configure Docus](/concepts/configuration) to fit your branding, handle SEO, set your locale, and adapt links and socials.
