...
C'est ici que vous pouvez configurer Docus pour l'adapter à votre marque, gérer le SEO, définir votre locale et adapter les liens et réseaux sociaux. Consultez la [documentation de configuration](https://docus.dev/concepts/configuration) pour plus de détails.
