...
Une fois votre contenu déplacé dans le dossier `content/`, vous pouvez personnaliser votre application en suivant la [documentation de configuration](https://docus.dev/concepts/configuration).
